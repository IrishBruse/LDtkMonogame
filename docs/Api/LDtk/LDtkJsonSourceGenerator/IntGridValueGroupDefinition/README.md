# LDtkJsonSourceGenerator\.IntGridValueGroupDefinition Property
...
```csharp
public System.Text.Json.Serialization.Metadata.JsonTypeInfo<LDtk.IntGridValueGroupDefinition> IntGridValueGroupDefinition { get; }
```
